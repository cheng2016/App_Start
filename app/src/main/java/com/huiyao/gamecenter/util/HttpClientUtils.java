...
public class HttpClientUtils {
        ...
        Executors.newSingleThreadExecutor().execute(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Logger.e(TAG, "url : " + actionUrl, exception);
        ...
        Executors.newCachedThreadPool().execute(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Logger.e(TAG, "url : " + actionUrl, e);
                    callback.sendFailuerMessage(e);
                }
            }
        });
    }
    ...
    public abstract static class SimpleResponseCallback implements Callback {
        ...
        public SimpleResponseCallback() {
            ...
            Log.i(TAG, "IS MAIN LOOPER : " + (looper == Looper.getMainLooper()));
        }
