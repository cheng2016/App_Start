...
/**
 * @Created by: chengzj
 * @创建时间: 2022/6/23 15:50
 * @描述:
 */
public class InComeAdapter extends BaseAdapter {
    private Context context;
    private List<WithdrawalLogData.DataBean.IncomeBean> mList = new ArrayList<>();

    public InComeAdapter(Context context) {
        this.context = context;
    }

    public InComeAdapter(Context context, List<WithdrawalLogData.DataBean.IncomeBean> mList) {
        this.context = context;
        this.mList = mList;
    }

    public void updateData(List<WithdrawalLogData.DataBean.IncomeBean> list) {
        this.mList = list;
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ...
        WithdrawalLogData.DataBean.IncomeBean bean = mList.get(i);

        viewHolder.tvUserOrderInfo.setText(bean.getDesc()+"");
